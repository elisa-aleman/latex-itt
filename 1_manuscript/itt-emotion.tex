...
\section{Discussion}\label{discussion}
  ...
  \subsection{Price range differences}\label{disc:price}

    % some big paragraph about changing the way they speak, and about expectations, nice surprise, etc. 
    % Introduce the concept of logical expectations vs feelings expectations.
    % For example expecting it to be clean: ok just as expected / what?! it's not clean?! / cigarette
    %             expecting them to be nice: Still feel happy after they were nice
    % Omotenashi comes in play here.

    % paragraph about differences in perceptions from each culture
    % 

    % paragraph about things that stay the same across all prices
