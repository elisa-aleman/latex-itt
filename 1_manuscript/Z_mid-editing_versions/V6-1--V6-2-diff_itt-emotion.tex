...
%DIF DEL itt-emotion_V6-1.tex   Wed Feb 24 16:45:19 2021
...
\begin{abstract}
  ...
  Previous research \DIFaddbegin \DIFadd{in satisfaction }\DIFaddend has shown that different cultural backgrounds give rise to different expectations and \DIFdelbegin \DIFdel{arguably, }\DIFdelend \DIFaddbegin \DIFadd{thus }\DIFaddend different satisfaction factors. We performed a cross-cultural study on the different reactions to the high-standard Japanese hospitality environment between Chinese and Western cultures, to see if \DIFdelbegin \DIFdel{these cultures value service }\DIFdelend \DIFaddbegin \DIFadd{services are valued }\DIFaddend over other factors \DIFaddbegin \DIFadd{in different price ranges}\DIFaddend . We compared soft attributes, such as service, with hard attributes, such as location and facilities.
  We \DIFdelbegin \DIFdel{examined the differences in each population's satisfaction and dissatisfaction factors in different price ranges. Taking advantage of the facile data gathering capability enabled by the Web 2.0 technology, we }\DIFdelend \DIFaddbegin \DIFadd{collected our data with web crawling, labeled a sample, }\DIFaddend applied Shannon's entropy \DIFdelbegin \DIFdel{metric }\DIFdelend to extract these factors \DIFdelbegin \DIFdel{automatically }\DIFdelend and then used them \DIFdelbegin \DIFdel{in a support vector machine }\DIFdelend to classify a more extensive data set \DIFaddbegin \DIFadd{with an SVM}\DIFaddend . We then used dependency parsing and part-of-speech tagging to extract the nouns that were tied to \DIFdelbegin \DIFdel{``praising'' }\DIFdelend \DIFaddbegin \DIFadd{positive }\DIFaddend adjectives. 
