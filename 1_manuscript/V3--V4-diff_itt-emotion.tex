...
%DIF ADD itt-emotion.tex      Sun Nov 22 00:22:00 2020
%
...
. Other models, such as the GLOBE model, also take issue with some of Hofstede's dimensions and replace them with others, making a total of 9 dimensions . The }\textit{\DIFadd{masculinity-femininity}} \DIFadd{dimension, for example, is proposed to be instead two dimensions: }\textit{\DIFadd{gender egalitarianism}} \DIFadd{and }\textit{\DIFadd{assertiveness}}\DIFadd{. This avoids making the assumption that assertiveness is either masculine or feminine, which stems from outdated gender stereotypes. Gender stereotypes such as these have also been subject of critique for Hofstede's model\mbox{%DIFAUXCMD
