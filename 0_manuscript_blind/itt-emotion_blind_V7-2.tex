...
\begin{abstract}
  ...
  Since culture influences expectations, perceptions, and satisfaction, a cross-culture study is necessary to understand the differences between Japan's biggest tourist populations, Chinese and Western tourists. 
  ...
  Our study analyzed their satisfaction factors comparing soft attributes, such as service, with hard attributes, such as location and facilities, and studied different price ranges.
  We collected hotel reviews and extracted keywords to classify the sentiment of sentences with an SVC. We then used dependency parsing and part-of-speech tagging to extract nouns tied to positive adjectives.
  We found that Chinese tourists consider room quality more than hospitality, whereas Westerners are delighted more by staff behavior. Furthermore, the lack of a Chinese-friendly environment for Chinese customers and cigarette smell for Western ones can be disappointing factors of their stay. 
...
\section{Introduction}\label{intro}
  ...
  The Japanese tourist market is gradually becoming diverse because of multicultural tourist populations. This diversity means that the expectations when staying at a hotel will be varied. Cultural backgrounds have a decisive role in aspects of satisfaction and in the perceptions of quality \cite[][]{mattila1999role,winsted1997service}, or behavioral intentions \cite[][]{liu2001relationships}, such as the difference in Westerners and Asians in their willingness to pay more \cite[][]{LEVY2010319}. Since a difference in cultural background can also heavily influence the expectations of customers, as well as their perceptions of quality, the difference between these two can be smaller or larger depending on the culture in reaction to the same service. 
