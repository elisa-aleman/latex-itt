...
%DIF DEL itt-emotion_blind_V4.tex   Thu Nov 26 19:04:57 2020
%DIF ADD itt-emotion_blind.tex      Wed Dec 23 14:13:48 2020
%
...
\title{\DIFdelbegin \DIFdel{Cross-culture differences }\DIFdelend \DIFaddbegin \DIFadd{Differences }\DIFaddend in \DIFaddbegin \DIFadd{Chinese and Western }\DIFaddend tourists faced with Japanese hospitality: A \DIFdelbegin \DIFdel{text mining and }\DIFdelend natural language processing \DIFdelbegin \DIFdel{study of satisfaction and dissatisfaction factors in Chinese and Western cultures}\DIFdelend \DIFaddbegin \DIFadd{approach}\DIFaddend }

% Fold 1
  % Fold 2
    % Fold 3
      % Fold 4
        \DIFdelbegin %DIFDELCMD < \titlerunning{Cross-culture differences in tourists faced with Japanese hospitality: A text ...}
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \titlerunning{Differences in Chinese and Western tourists faced with Japanese hospitality: ...}
\DIFaddend 
...
\section{Introduction}\label{intro}
  ...
  However, \DIFdelbegin \DIFdel{a great majority of tourist behavior analysis has }\DIFdelend \DIFaddbegin \DIFadd{many tourist behavior analyses have }\DIFaddend been performed with Western subjects\DIFdelbegin \DIFdel{and }\DIFdelend \DIFaddbegin \DIFadd{. As such, }\DIFaddend a gap in knowledge and discussion existed until \DIFdelbegin \DIFdel{the }\DIFdelend recent decades. Those studies that do include Asian populations in their analysis most commonly study Chinese tourist behavior \cite[e.g.][]{liu2019, chang2010, dongyang2015}. The few that compare Asian to \DIFdelbegin \DIFdel{western }\DIFdelend \DIFaddbegin \DIFadd{Western }\DIFaddend tourist behavior \cite[e.g.][]{choi2000} are commonly survey or interview-based studies with small samples\DIFdelbegin \DIFdel{, which, }\DIFdelend \DIFaddbegin \DIFadd{. These, }\DIFaddend while valid, can have \DIFdelbegin \DIFdel{its }\DIFdelend \DIFaddbegin \DIFadd{their }\DIFaddend limitations. This gap in research creates a need for cross-cultural studies for the increasing Asian and Western tourist populations. It could be said that Westerners make for a smaller portion of the tourist population compared to Asians. However, according to \cite{choi2000}, Westerners are known as ``long-haul" customers, spending more than 45\% of their budget on hotel lodging. In comparison, their Asian counterparts only spend 25\% of their budget on hotels. Therefore, it is essential to study Asian and Western tourist populations, their differences, and contrast with the existing literature results.
  ...
  In this study, we take advantage of the availability of enormous amounts of online reviews of Japanese hotels by both Mainland Chinese tourists posting in \textit{Ctrip} and Western English-speaking tourists populations posting in \textit{TripAdvisor}. With this data, we can confirm existing theories about their differences in behavior and \DIFdelbegin \DIFdel{perform an exploration of }\DIFdelend \DIFaddbegin \DIFadd{explore }\DIFaddend the data to discover factors that could have been overlooked in the past. To do this, we use machine learning to automatically classify review sentences as positive or negative opinions of the hotel. We then perform a statistical extraction of the topics that concerns the customers of each population the most.

\section{Research objective}\label{research_objective}

  This study's objective is to determine the difference in factors driving satisfaction and dissatisfaction between Chinese and English-speaking tourists in the context of high-grade hospitality of Japanese hotels using text-mining techniques. We aim to contrast customer groups' satisfaction and dissatisfaction factors across several price ranges. We use machine learning to classify texts' sentiment and natural language processing to study commonly used word pairings. More importantly, we also intend to measure how hard and soft attributes influence customer groups' satisfaction and dissatisfaction. We define hard attributes as relating to \DIFdelbegin \DIFdel{physicial }\DIFdelend \DIFaddbegin \DIFadd{physical }\DIFaddend aspects and environmental aspects, such as the \DIFdelbegin \DIFdel{facilities of the hotel}\DIFdelend \DIFaddbegin \DIFadd{hotel's facilities, the hotel's location, infrastructure}\DIFaddend , \DIFdelbegin \DIFdel{the location of the hotel, infrastructure }\DIFdelend and real estate nearby. In contrast, soft attributes are the \DIFaddbegin \DIFadd{hotel's }\DIFaddend non-physical attributes \DIFdelbegin \DIFdel{of the hotel }\DIFdelend related to services, staff\DIFaddbegin \DIFadd{, }\DIFaddend or management.

  Our proposal includes using large scale data from online hotel reviews in Chinese and English to study their differences in a statistical manner. In the past, survey-based studies have provided a theoretical background for a few specific tourist populations of a single culture or that travel with a single purpose. \DIFdelbegin \DIFdel{The short scope of those studies means that }\DIFdelend \DIFaddbegin \DIFadd{These studies' short scope often leads to difficulties in observing }\DIFaddend cultural and language differences \DIFdelbegin \DIFdel{often cannot be observed }\DIFdelend in a single study.
...
\section{Theoretical background and hypothesis development}\label{theory_hypothesis}
  ...
  \subsection{Japanese hospitality and service: \textit{Omotenashi}}\label{theory_omotenashi}
    ...
    The spirit of Japanese hospitality, or \textit{Omotenashi}, has roots in the countries history. However, to this day, it is regarded as the highest standard \cite[][]{ikeda2013omotenashi, al2015characteristics}. There is even a famous phrase in customer service in Japan: \textit{okyaku-sama wa kami-sama desu}, or translated ``The customer is god''. Some say that \textit{omotenashi} originated from the old Japanese art of the tea ceremony in the 16th century. However, other scholars found that its roots come from even earlier, in the form of formal banquets in the 7th-century \cite[][]{aishima2015origin}. The practice of high standards in hospitality has survived throughout the years. Today, it permeates all business practices in Japan, from the cheapest convenience stores to the most expensive ones. Manners, service, and respect towards the customer are taught to workers in their training. High standards are always followed as to not fall behind in the competition. In Japanese businesses, hotels included, staff members are trained to speak in \textit{sonkeigo}, or ``respectful language", one of the most formal of the Japanese formality syntaxes. They are also trained to bow with different depths depending on the situation, where a light bow could be used to say: ``Please, allow me to guide you". Deep bows are also used to apologize for any inconvenience the customer could have, followed by a very respectful apology. In fact, despite the word \textit{omotenashi} being translated directly as ``hospitality'', it includes both the concepts of hospitality and service \cite[][]{Kuboyama2020}. This \DIFdelbegin \DIFdel{is permeating into }\DIFdelend \DIFaddbegin \DIFadd{hospitality culture permeates }\DIFaddend every kind of business with customer interaction in Japan\DIFdelbegin \DIFdel{, where a }\DIFdelend \DIFaddbegin \DIFadd{. A }\DIFaddend simple convenience shop could express all of these \DIFdelbegin \DIFdel{standards of }\DIFdelend hospitality and service \DIFdelbegin \DIFdel{, which aren't }\DIFdelend \DIFaddbegin \DIFadd{standards, which are not }\DIFaddend exclusive to hotels.  

    It stands to reason that this cultural aspect of hospitality would be a positive aspect that would be at the top of satisfaction for any customer. However, in many cases, other factors such as proximity to a convenience store, \DIFdelbegin \DIFdel{or }\DIFdelend transport availability, or \DIFdelbegin \DIFdel{perhaps }\DIFdelend room quality might be more critical to a customer.  In this study, we cannot determine whether or not a hotel is practicing with the cultural standards of \textit{omotenashi} directly\DIFdelbegin \DIFdel{, but rather }\DIFdelend \DIFaddbegin \DIFadd{. Instead, we }\DIFaddend consider it as a cultural factor that influences all businesses in Japan\DIFdelbegin \DIFdel{and }\DIFdelend \DIFaddbegin \DIFadd{. We then }\DIFaddend observe the customers\DIFaddbegin \DIFadd{' }\DIFaddend evaluations regarding service and hospitality factors in general, which can be compared to other places and business \DIFdelbegin \DIFdel{practice }\DIFdelend \DIFaddbegin \DIFadd{practices }\DIFaddend in the world. In summary, our study considers the influence of the cultural aspect of \textit{omotenashi} \DIFdelbegin \DIFdel{, while only studying }\DIFdelend \DIFaddbegin \DIFadd{while analyzing }\DIFaddend the evaluations of service \DIFdelbegin \DIFdel{, hospitality and staff behavior }\DIFdelend \DIFaddbegin \DIFadd{and hospitality }\DIFaddend factors that are universal to all hotels in any country.
  ...
  \subsection{Customer satisfaction and dissatisfaction towards individual factors during hotel stay}\label{theory_satisfaction}
    ...
    \DIFdelbegin \DIFdel{In }\DIFdelend \DIFaddbegin \DIFadd{However, in }\DIFaddend this study, \DIFdelbegin \DIFdel{however, }\DIFdelend we study not overall customer satisfaction \DIFdelbegin \DIFdel{, }\DIFdelend but the satisfaction and dissatisfaction that stem from \DIFdelbegin \DIFdel{individual specific }\DIFdelend \DIFaddbegin \DIFadd{individual-specific }\DIFaddend expectations, be they conscious or unconscious. For example, \DIFdelbegin \DIFdel{if }\DIFdelend \DIFaddbegin \DIFadd{suppose }\DIFaddend a customer has a conscious expectation of a comfortable bed and a wide shower, and it is realized during their visit\DIFaddbegin \DIFadd{. In that case}\DIFaddend , they will be satisfied with this matter. However\DIFdelbegin \DIFdel{if }\DIFdelend \DIFaddbegin \DIFadd{, suppose }\DIFaddend that same customer \DIFdelbegin \DIFdel{had }\DIFdelend \DIFaddbegin \DIFadd{with }\DIFaddend a conscious expectation of a comfortable \DIFdelbegin \DIFdel{sleep but there were }\DIFdelend \DIFaddbegin \DIFadd{bed experienced }\DIFaddend loud noises at night\DIFdelbegin \DIFdel{, that is a different aspect that }\DIFdelend \DIFaddbegin \DIFadd{. In that case, }\DIFaddend they can be dissatisfied with \DIFaddbegin \DIFadd{a different aspect}\DIFaddend , regardless of the satisfaction towards the bed. Then, the same customer might have packed their \DIFdelbegin \DIFdel{own }\DIFdelend toiletries, thinking that the amenities might not include those\DIFdelbegin \DIFdel{, and }\DIFdelend \DIFaddbegin \DIFadd{. They can }\DIFaddend then be pleasantly surprised with good quality amenities and toiletries, satisfying an unconscious expectation. \DIFdelbegin \DIFdel{While this }\DIFdelend \DIFaddbegin \DIFadd{This }\DIFaddend definition of satisfaction \DIFdelbegin \DIFdel{and our current method }\DIFdelend does not allow us to examine overall customer satisfaction\DIFaddbegin \DIFadd{. However}\DIFaddend , it will allow us to examine the factors that a hotel can revise individually \DIFdelbegin \DIFdel{, and how they are perceived by a population }\DIFdelend \DIFaddbegin \DIFadd{and how a population perceives them }\DIFaddend as a whole. In our study, we consider the definitions by \cite{hunt1975} that satisfaction is a realization of an expectation, and posit that customers can have different expectations towards different \DIFdelbegin \DIFdel{aspects of a service . In }\DIFdelend \DIFaddbegin \DIFadd{service aspects. Therefore, in }\DIFaddend our study, \DIFdelbegin \DIFdel{therefore, }\DIFdelend we define satisfaction as the emotional response to the realization or overcoming of conscious or unconscious expectations towards an individual aspect or factor of a service. \DIFdelbegin \DIFdel{Dissatisfaction, on }\DIFdelend \DIFaddbegin \DIFadd{On }\DIFaddend the other hand, \DIFaddbegin \DIFadd{dissatisfaction }\DIFaddend is the emotional response to the lack of a realization \DIFdelbegin \DIFdel{, or an }\DIFdelend \DIFaddbegin \DIFadd{or }\DIFaddend under-performance of these conscious or unconscious expectations towards specific \DIFdelbegin \DIFdel{aspects of a service }\DIFdelend \DIFaddbegin \DIFadd{service aspects}\DIFaddend .

    Studies on customer satisfaction \cite[e.g.][]{truong2009, romao2014, wu2009} commonly use the Likert scale \cite[][]{likert1932technique} (e.g. 1 to 5 scale from strongly dissatisfied to strongly satisfied) to perform statistical analysis of which factors relate most to satisfaction on the same dimension as dissatisfaction \cite[e.g.][]{chan201518, choi2000}. The \DIFdelbegin \DIFdel{use of the Likert scale}\DIFdelend \DIFaddbegin \DIFadd{Likert scale's use }\DIFaddend leads to correlation analyses where one factor can lead to satisfaction, implying that the lack of it can lead to dissatisfaction. However, a binary distinction (satisfied or dissatisfied) could allow us to analyze the factors that correlate to satisfaction and explore factors that are solely linked to dissatisfaction. There are fewer examples of this approach, but studies have done this in the past \cite[e.g.][]{zhou2014}. This method can indeed decrease the extent to which we can analyze degrees of satisfaction or dissatisfaction. However, it has the benefit that it can be applied to a large sample of text data via automatic sentiment detection techniques using artificial intelligence. 

    Previous research has also focused more on soft attributes\DIFdelbegin \DIFdel{that are controllable by the hotel managers and staff, i.e., hotel services, staff behavior, }\DIFdelend \DIFaddbegin \DIFadd{, }\DIFaddend with little focus on hard attributes, like location or infrastructure, mostly focusing only on facilities \cite[e.g.][]{shanka2004, choi2001}. However, hard factors\DIFaddbegin \DIFadd{, which are }\DIFaddend uncontrollable by the hotel staff\DIFaddbegin \DIFadd{, }\DIFaddend can play a part in the customers' choice behavior and satisfaction. Examples of these factors include the hotel's surroundings, location, language immersion of the country as a whole, or touristic destinations, \DIFdelbegin \DIFdel{as well as the integration of the hotel}\DIFdelend \DIFaddbegin \DIFadd{and the hotel's integration }\DIFaddend with tours available nearby, among other factors. 
...
%DIFDELCMD <   %%%
\DIFdelend \subsection{Chinese and Western tourist behavior}\label{theory_zh_en}

    % Asians vs. Western behavior
    In the past, social science and tourism studies focused \DIFdelbegin \DIFdel{greatly }\DIFdelend \DIFaddbegin \DIFadd{extensively }\DIFaddend on Western tourist behavior in other countries. Recently, however, with the rise of Chinese outbound tourism, both academic researchers and businesses have decided to study Chinese tourist behavior. Explaining this increase, \cite{sun2017} analyzed the number of studies related to Chinese tourists from 2001 to 2012 and found a steady increase until 2007, followed by the rapid growth of \DIFdelbegin \DIFdel{studies on Chinese tourism }\DIFdelend \DIFaddbegin \DIFadd{Chinese tourism studies}\DIFaddend . This increase in \DIFdelbegin \DIFdel{research on }\DIFdelend Chinese tourist behavior \DIFaddbegin \DIFadd{research }\DIFaddend resulted in several studies focusing on only the behavior of this subset of tourists. To this day, studies and analyses specifically comparing Asian and Western tourists are scarce, and even less the number of studies \DIFdelbegin \DIFdel{specifically }\DIFdelend \DIFaddbegin \DIFadd{explicitly }\DIFaddend comparing Chinese and Western tourists. One example is a study by \cite{choi2000}, who found that Western tourists visiting Hong Kong are satisfied more with room quality\DIFaddbegin \DIFadd{, }\DIFaddend while Asians are satisfied with the value for money. Another study by \cite{bauer1993changing} found that Westerners prefer \DIFdelbegin \DIFdel{the }\DIFdelend hotel health facilities\DIFdelbegin \DIFdel{while the }\DIFdelend \DIFaddbegin \DIFadd{. At the same time, }\DIFaddend Asian tourists were more inclined to enjoy the Karaoke facilities of hotels\DIFdelbegin \DIFdel{, and both }\DIFdelend \DIFaddbegin \DIFadd{. Both }\DIFaddend groups tend to have high expectations \DIFdelbegin \DIFdel{about }\DIFdelend \DIFaddbegin \DIFadd{for }\DIFaddend the overall facilities. Another study done by \cite{kim2000} found that American tourists were found to be individualistic and motivated by novelty. In contrast, Japanese tourists were collectivist and motivated by prestige and family, with an escape from routine and \DIFdelbegin \DIFdel{an increase in }\DIFdelend \DIFaddbegin \DIFadd{increased }\DIFaddend knowledge as a common motivator. 

    One thing to note with the above Asian vs. Western analyses is that they were performed before 2000 \DIFdelbegin \DIFdel{, }\DIFdelend and that they are not Chinese specific \DIFdelbegin \DIFdel{, }\DIFdelend but study Asian people in general. Meanwhile, the current Chinese economy boom is \DIFdelbegin \DIFdel{making an increase in }\DIFdelend \DIFaddbegin \DIFadd{increasing }\DIFaddend the influx of tourists of this nation. The resulting increase in marketing and the creation of guided tours for Chinese tourists could have created a difference in tourists' perceptions and expectations. In turn, if we follow the definition of satisfaction by \cite{hunt1975}, that change in expectations could have influenced their satisfaction factors when traveling. Another note is that these studies were performed with questionnaires in places where it would be easy to locate tourists, i.e., airports. However, our study of online reviews takes the data that the hotel customers uploaded themselves\DIFdelbegin \DIFdel{, making }\DIFdelend \DIFaddbegin \DIFadd{. This data makes }\DIFaddend the analysis unique in \DIFdelbegin \DIFdel{the exploring of their behavior in comparison }\DIFdelend \DIFaddbegin \DIFadd{exploring their behavior compared }\DIFaddend with Western tourists \DIFdelbegin \DIFdel{, as well as studying them in the }\DIFdelend \DIFaddbegin \DIFadd{via factors that are not considered in most other studies. Furthermore, our study is unique in observing the customers in the }\DIFaddend specific environment of high-level hospitality in Japan\DIFdelbegin \DIFdel{and observing hard factors that are not considered in most other studies}\DIFdelend .
...
\section{Methodology}\label{method}
  ...
  \subsection{Sentiment analysis using a Support Vector Classifier}\label{sentimentanalysis}
    ...
    Shannon's entropy can be used to observe the probability distribution of each word inside the corpus. A word \DIFdelbegin \DIFdel{that is }\DIFdelend included in many documents will have a high entropy value for that set of documents. Opposite to this, a word appearing in only one document will have an entropy value of zero. 
...
\section{Data Analysis}\label{dataanalysis}
  ...
  \subsection{Determining hard and soft attribute usage}\label{det_hard_soft}
    ...
    To further understand the differences in satisfaction and dissatisfaction in Chinese and Western customers of Japanese hotels, we classified these factors as either hard or soft attributes of a hotel. We define hard attributes as matters regarding \DIFaddbegin \DIFadd{the hotel's }\DIFaddend physical or environmental aspects\DIFdelbegin \DIFdel{of the hotel}\DIFdelend , such as facilities, location, or infrastructure\DIFdelbegin \DIFdel{, that }\DIFdelend \DIFaddbegin \DIFadd{. Some of these aspects }\DIFaddend would be impractical for the hotel to change, such as \DIFdelbegin \DIFdel{the hotel's }\DIFdelend \DIFaddbegin \DIFadd{its }\DIFaddend surroundings and location\DIFdelbegin \DIFdel{, or impractical and }\DIFdelend \DIFaddbegin \DIFadd{. Others can be }\DIFaddend expensive to change, such as matters requiring construction costs, which are possible but regarding \DIFdelbegin \DIFdel{investment in infrastructure }\DIFdelend \DIFaddbegin \DIFadd{infrastructure investment}\DIFaddend . On the other hand, soft attributes are the non-physical attributes of the hotel service and staff behavior that are practical to change through management. For example, the hotel's services or the cleanliness of the rooms are soft attributes. For our purposes, amenities, clean or good quality bedsheets or curtains, and other physical attributes that are part of the service and not of the \DIFdelbegin \DIFdel{physical structure of the hotel }\DIFdelend \DIFaddbegin \DIFadd{hotel's physical structure }\DIFaddend are also considered soft attributes. Thus, we can observe the top 10 satisfaction and dissatisfaction keywords and determine whether they are soft or hard attributes.
...
\section{Results}\label{results}
  ...
  \subsection{Experiment results and answering research questions}
    ...
    In our research questions \ref{rsq:hard_soft} and \ref{rsq:hard_soft_diff}, we ponder how customers of both cultural backgrounds \DIFdelbegin \DIFdel{react to }\DIFdelend \DIFaddbegin \DIFadd{evaluate }\DIFaddend hard and soft attributes of the hotel \DIFdelbegin \DIFdel{, }\DIFdelend and how they differ in those \DIFdelbegin \DIFdel{reactions}\DIFdelend \DIFaddbegin \DIFadd{evaluations}\DIFaddend . Here we define hard attributes as those relating to \DIFaddbegin \DIFadd{the hotel's }\DIFaddend physical, structural\DIFaddbegin \DIFadd{, }\DIFaddend or environmental aspects\DIFdelbegin \DIFdel{of the hotel, which }\DIFdelend \DIFaddbegin \DIFadd{. These }\DIFaddend are often impossible or impractical to change \DIFdelbegin \DIFdel{directly }\DIFdelend by the hotel management and staff, such as facilities, infrastructure, the surroundings, view, or location convenience. On the other hand, \DIFdelbegin \DIFdel{soft attributes are those that the }\DIFdelend hotel staff and management \DIFdelbegin \DIFdel{could practically change directly, such as }\DIFdelend \DIFaddbegin \DIFadd{can change soft attributes, for example, by }\DIFaddend improving the hotel's services via training or hiring specialized staff, improving the quantity or quality of amenities, bedsheets, or general cleanliness. \DIFdelbegin \DIFdel{In our study , we find }\DIFdelend \DIFaddbegin \DIFadd{Our study found }\DIFaddend that Chinese tourists are mostly positively reacting more to the hotel's hard attributes. There is a slightly hard leaning (53\%) concern with hard attributes in negative sentences, albeit \DIFdelbegin \DIFdel{it }\DIFdelend \DIFaddbegin \DIFadd{this }\DIFaddend is more uniform \DIFdelbegin \DIFdel{in this instance}\DIFdelend \DIFaddbegin \DIFadd{than the positive evaluations}\DIFaddend . English-speaking tourists, on the other hand, are both positively and negatively more responsive to soft attributes. In the case of negative keywords, English-speaking tourists are overwhelmingly more concerned with the hotel's soft attributes dissatisfaction somehow.

    One factor that both populations have in common is, when perceiving the hotel negatively, ``\begin{CJK}{UTF8}{gbsn}老\end{CJK} (old)'', ``dated'', ``outdated'', or ``\begin{CJK}{UTF8}{gbsn}陈旧\end{CJK} (obsolete)'' aspects of the room or the hotel are being criticized across, surprisingly, most price ranges. This is, however, a hard attribute \DIFdelbegin \DIFdel{, }\DIFdelend and is unlikely to change for most hotels.
  ...
  \subsection{Western tourists - A friendly face, and absolutely clean}\label{disc:en}
    ...
    While less high in priority, the price range of 15,000 to 20,000 yen hotels also mentions ``free'' as one of the top 10 positive keywords, paired mostly with ``wifi''. This price range is mostly for business hotels\DIFaddbegin \DIFadd{, }\DIFaddend where we infer users would be expecting this feature the most. Western tourists are highly sensitive to comfort levels in the hotels and whether it reaches their expectations.


  \subsection{Tobacco, what's that smell?}\label{disc:tobacco}

    A concern for Western tourists was the smell of tobacco in their room\DIFdelbegin \DIFdel{. This }\DIFdelend \DIFaddbegin \DIFadd{, which }\DIFaddend can be considered a soft attribute. \DIFdelbegin \DIFdel{Not }\DIFdelend \DIFaddbegin \DIFadd{Tobacco was found not }\DIFaddend only as a standalone word \DIFdelbegin \DIFdel{of }\DIFdelend ``cigarette'', but also \DIFdelbegin \DIFdel{confirming with }\DIFdelend \DIFaddbegin \DIFadd{as }\DIFaddend word pairs in Table \ref{tab:adj_en_neg}\DIFdelbegin \DIFdel{, we }\DIFdelend \DIFaddbegin \DIFadd{. We }\DIFaddend can find other related word pairs such as ``funny smell''. Upon manual inspection of a sample of reviews with this keyword, we found that the room was often advertised as \DIFdelbegin \DIFdel{non- smoking}\DIFdelend \DIFaddbegin \DIFadd{non-smoking}\DIFaddend , yet, the smell permeated the room and curtains. Another common complaint was that there were no non-smoking facilities available at all in the first place. The smell of smoke can completely ruin some customers’ stay and give a bad impression to review writers, lowering the number of future customers.
    ...
    Japan has a polarized view on \DIFdelbegin \DIFdel{smoking, and despite }\DIFdelend \DIFaddbegin \DIFadd{the topic of smoking. Despite }\DIFaddend being one of the world’s largest tobacco markets, its use has \DIFdelbegin \DIFdel{been decreasing }\DIFdelend \DIFaddbegin \DIFadd{decreased }\DIFaddend in recent years. Smoking in public spaces is prohibited in some wards of Tokyo (namely Chiyoda, Shinjuku, and Shibuya). However, it is generally only urged and not mandatory to have smoking restrictions in restaurants, bars, hotels, and public areas. However, many places have designated smoking rooms are available to keep the smoke \DIFdelbegin \DIFdel{to }\DIFdelend \DIFaddbegin \DIFadd{in }\DIFaddend an enclosed area and avoid bothering others. Despite this, businesses, especially those who cater to certain customers, will generally be discouraged from having smoking restrictions if they want to keep their clientele. If Japanese hotels want to cater to all kinds of customers, Western and Asian alike, they must provide spaces without tobacco smell. After all, even if it does not bother a few customers, the lack of smell would make it an appropriate space for all customers.
...
\section{Discussion}\label{discussion}
  ...
  \subsection{Western and Chinese tourists in the Japanese hospitality environment}\label{disc:omotenashi}
    ...
    Our initial question was whether the environment of high-grade hospitality would affect both cultures equally. This study brought us closer to the answer. On the one hand, there is a possibility that Chinese customers did have high-grade hospitality and did not get equally satisfied with Westerners. In that case, it appears that the difference stems from a psychological source. Expectation leads to satisfaction \DIFdelbegin \DIFdel{, }\DIFdelend and a lack of expectation results in lesser satisfaction. On the other hand, there is also a possibility that Chinese customers are not receiving the highest grade of hospitality because of cultural friction between Japan and China.
  ...
  \subsection{Hard vs. soft satisfaction factors}\label{disc:hard_soft}
    ...
    As we stated in section 3.2, previous research is focused mostly on the hotel's soft attributes and their influence on customer satisfaction. Examples of soft attributes include staff behavior, commodities, amenities, and appliances that can be improved within the hotel \cite[e.g.][]{shanka2004,choi2001}. However, hard attributes \DIFdelbegin \DIFdel{, such as }\DIFdelend \DIFaddbegin \DIFadd{are not usually analyzed in satisfaction studies. Examples of hard attributes include }\DIFaddend the hotel's location relative to public transport and shops, language immersion of the country, noise pollution, or weather\DIFdelbegin \DIFdel{, are not usually analyzed in satisfaction studies}\DIFdelend . Because our study left the satisfaction factors to be decided statistically via customers’ online reviews, we can see the importance of those hard or soft attributes in their priorities.
    ...
    Around half of the dissatisfaction factors for both Chinese and Western customers are caused by issues that could be solved with improved management. \DIFdelbegin \DIFdel{This }\DIFdelend \DIFaddbegin \DIFadd{The previous }\DIFaddend is true for all price ranges. Of course, the improvements could be staff training (perhaps in language), hiring professional cleaning services for rooms with cigarette smoke smells, or improving the bedding\DIFdelbegin \DIFdel{, all of which }\DIFdelend \DIFaddbegin \DIFadd{. All of these options }\DIFaddend can be costly. However, this paper provides a good guideline for which factors to consider first and which ones will be best suited to each customer group. Hotels can use the price range categorization in order to choose the appropriate strategy as well. However, once the \DIFaddbegin \DIFadd{hotel's }\DIFaddend location and construction \DIFdelbegin \DIFdel{of the hotel }\DIFdelend are set for Chinese customers, not much else can be done to satisfy them further. As mentioned before, Chinese language availability is another soft attribute that can be improved with staff and training investment.

    On the other hand, Western tourists are all around dissatisfied with mostly soft attributes\DIFdelbegin \DIFdel{, with }\DIFdelend \DIFaddbegin \DIFadd{. They show this by having }\DIFaddend a low of 35\% in the highest price range where undefined factors are the majority \DIFdelbegin \DIFdel{, }\DIFdelend and 78\% at most in the price range from 30,000 to 50,000 yen per night in a hotel. The room for improvement for Western tourists is more extensive than their Chinese counterparts. As such, it presents a bigger investment opportunity. As mentioned earlier in this paper, Westerners are known as ``long-haul'' customers, spending more than 45\% of their budget on hotel lodging.
    ...
    In \cite{donthu1998cultural}, subjects from 10 different countries were compared in their expectations of service quality and analyzed through the lens of Hofstede's typology of culture \cite[][]{hofstede1984culture}\DIFdelbegin \DIFdel{, where it is stated }\DIFdelend \DIFaddbegin \DIFadd{. That study states }\DIFaddend that although culture has no one specific index, five dimensions of culture can be used to analyze or categorize a country in comparison to others. These are \textit{power distance}, \textit{uncertainty avoidance}, \textit{individualism-collectivism}, \textit{masculinity-femininity}, and \textit{long-term versus short-term orientation}. In each of these dimensions, at least one element of service expectations \DIFdelbegin \DIFdel{were }\DIFdelend \DIFaddbegin \DIFadd{was }\DIFaddend found to be significantly different for countries grouped under contrasting attributes (e.g.\DIFaddbegin \DIFadd{, }\DIFaddend individualistic countries vs\DIFaddbegin \DIFadd{. }\DIFaddend collectivist countries, high uncertainty avoidance countries vs\DIFaddbegin \DIFadd{. }\DIFaddend low uncertainty avoidance countries). \DIFdelbegin \DIFdel{Although }\DIFdelend \DIFaddbegin \DIFadd{However, }\DIFaddend Hofstede's typology \DIFaddbegin \DIFadd{has received criticism from academics}\DIFaddend , particularly the fifth dimension \DIFaddbegin \DIFadd{that Hofstede proposed}\DIFaddend , which was added \DIFaddbegin \DIFadd{afterward }\DIFaddend with the alternate name \textit{Confucian dynamic}\DIFdelbegin \DIFdel{, has received criticism from academics }\DIFdelend \DIFaddbegin \DIFadd{. Academics }\DIFaddend with a Chinese background \DIFaddbegin \DIFadd{criticized Hofstede }\DIFaddend for being misinformed on the philosophical aspects of Confucianism, as well as being a difficult dimension to measure \cite[][]{fang2003critique}. Other models, such as the GLOBE model, also take issue with some of Hofstede's dimensions and replace them with others, making a total of 9 dimensions \cite[][]{house1999cultural}. The \textit{masculinity-femininity} dimension, for example, is proposed to be instead two dimensions: \textit{gender egalitarianism} and \textit{assertiveness}. This \DIFdelbegin \DIFdel{avoids making the assumption }\DIFdelend \DIFaddbegin \DIFadd{addition of dimensions avoids assuming }\DIFaddend that assertiveness is either masculine or feminine, which stems from outdated gender stereotypes. Gender stereotypes such as these have also been \DIFaddbegin \DIFadd{the }\DIFaddend subject of critique for Hofstede's model\cite[][]{jeknic2014gender}. Our study \DIFdelbegin \DIFdel{is in agreement }\DIFdelend \DIFaddbegin \DIFadd{agrees }\DIFaddend with these critiques \DIFdelbegin \DIFdel{, andtherefore }\DIFdelend \DIFaddbegin \DIFadd{and, therefore, }\DIFaddend will avoid considering these for our discussion.

    The \DIFdelbegin \DIFdel{background }\DIFdelend \DIFaddbegin \DIFadd{backgrounds }\DIFaddend of collectivism in China and individualism in Western countries \DIFdelbegin \DIFdel{that }\DIFdelend have been studied before \cite[][]{gao2017chinese}\DIFdelbegin \DIFdel{, }\DIFdelend \DIFaddbegin \DIFadd{. These backgrounds and }\DIFaddend the differences in these \DIFdelbegin \DIFdel{dimensions of culture }\DIFdelend \DIFaddbegin \DIFadd{cultural dimensions }\DIFaddend could be the underlying cause for differences in expectations. Regardless of the cause, however, measures in the past have proven that these differences in expectations exist \cite[][]{armstrong1997importance}. 

    For our purposes in contrasting Western vs. Chinese satisfaction stemming from expectations, these dimensions could \DIFdelbegin \DIFdel{provide insight into }\DIFdelend \DIFaddbegin \DIFadd{explain }\DIFaddend why Chinese customers are generally satisfied more often with hard factors while Westerners are satisfied or dissatisfied \DIFdelbegin \DIFdel{often }\DIFdelend with soft factors. Perhaps the cultural background of Chinese tourists emphasizes their surroundings and their place in nature and the environment. Chinese historical backgrounds of Confucianism, Taoism, and Buddhism permeate the thought processes of Chinese populations. However, scholars argue that the changes in generations and their economic and recent history gives less importance to these concepts in their lives \cite[][]{gao2017chinese}. 

    Nevertheless, one could argue that a Chinese cultural attribute emphasizes the environment and the place one is in towards satisfaction, rather than the way one is treated. According to previous research, Chinese tourists are collectivist, while Westerners are individualists \cite[][]{kim2000}. A more anthropocentric and individualistic Western culture could result in more of their expectations and priorities be related to how one is treated in social circumstances, rather than the environment one is in. According to \cite{donthu1998cultural}, highly individualistic customers have a higher expectation of empathy and assurance from the provider \DIFdelbegin \DIFdel{compared to collectivist customers, which }\DIFdelend \DIFaddbegin \DIFadd{than collectivist customers. Empathy and assurance from the provider }\DIFaddend are aspects of service, a soft attribute of a hotel. 
  ...
  \subsection{Satisfaction across different price ranges}\label{disc:price}
    ...
    In this paper, we follow the definition of satisfaction by \cite{hunt1975}, where \DIFdelbegin \DIFdel{it is the }\DIFdelend meeting or exceeding \DIFdelbegin \DIFdel{of expectations that }\DIFdelend \DIFaddbegin \DIFadd{expectations }\DIFaddend produces satisfaction. Therefore, the lack of meeting expectations would cause dissatisfaction. In the cases above, we can infer that a customer that pays more for a higher class of experience has higher expectations. This is true in dissatisfaction, where their expectation is higher in a more expensive hotel. As such, any lack of cleanliness \DIFdelbegin \DIFdel{or, in }\DIFdelend \DIFaddbegin \DIFadd{can lead to disappointment or outrage. In }\DIFaddend the case of English-speaking customers in the 30,000 to 50,000 yen per night price range, \DIFdelbegin \DIFdel{the smell of cigarettes can lead to disappointment or outrage}\DIFdelend \DIFaddbegin \DIFadd{cigarette smell is particularly disappointing}\DIFaddend . However, we consistently see customers with high expectations for high-class hotels react even more positively when satisfied. In the positive case, expectations appear to be exceeded in most cases, judging their reactions. We argue that these are two different kinds of interactions with expectations. We can observe logical expectations. Customers set a standard in their mind that the service must not fall below or be disappointed — for example, a customer being disappointed with dirty rooms or cigarette smell.

    In contrast, we can observe emotional expectations, where customers have a vague idea of having a positive experience. However, they do not measure it against any \DIFdelbegin \DIFdel{sort of }\DIFdelend standard. For example, having a \DIFdelbegin \DIFdel{nice }\DIFdelend \DIFaddbegin \DIFadd{pleasant }\DIFaddend customer service experience or being treated hospitably by the staff at a high-class hotel. Regardless of their knowledge beforehand of the service to be provided, positive emotions give them a perception of exceeded expectations \DIFdelbegin \DIFdel{, and thus a higher }\DIFdelend \DIFaddbegin \DIFadd{and high }\DIFaddend satisfaction. This is where hospitality and service come into play and enhances the experience of the customers. 

    There are interesting differences between Chinese and English-speaking tourists in their change in satisfaction factors to differently priced hotels. For example, we can observe that the Chinese tourists have ``\begin{CJK}{UTF8}{gbsn}购物\end{CJK} (shopping)'' as a top keyword in all the price ranges. In contrast, English-speaking tourists only mention it as a top keyword in the 20,000 to 30,000 yen price range. It is common knowledge in Japan that Chinese tourists coming to Japan with the express intention of shopping are common. \cite{tsujimoto2017purchasing} analyzed the souvenir purchasing behavior of Chinese tourists in Japan\DIFdelbegin \DIFdel{, and citing }%DIFDELCMD < \cite{japan2014consumption}%%%
\DIFdel{, }\DIFdelend \DIFaddbegin \DIFadd{. The study }\DIFaddend shows that common products besides food and drink are\DIFaddbegin \DIFadd{: }\DIFaddend electronics, cameras, cosmetics, medicine, among other more traditional \textit{souvenir} items, such as objects representative of the culture or places they visit \DIFaddbegin \cite{japan2014consumption}\DIFaddend . There is an understanding that \DIFdelbegin \DIFdel{the fact that }\DIFdelend tourists choose to shop in Japan has more to do with the quality of the items \DIFdelbegin \DIFdel{rather }\DIFdelend than their relation to the \DIFdelbegin \DIFdel{touristic }\DIFdelend \DIFaddbegin \DIFadd{tourist }\DIFaddend attractions. Our results suggest that Western tourists are engaging more in tourist attractions in comparison with shopping activities. Another interesting difference is that English-speaking tourists start using negative keywords about the hotel's price only after it concerns hotels of 15,000 yen or more, and it rises in its ranking the more expensive the hotel is. In contrast, Chinese customers have this keyword as their top keyword across all price ranges. Previous research suggests that value for money is a key concern for Chinese and Asian tourists \cite[][]{choi2000,choi2001,truong2009}, while Western customers are more concerned with hospitality \cite[][]{kozak2002}.  
    ...
    While some aspects of satisfaction and dissatisfaction change depending on the \DIFdelbegin \DIFdel{price range the hotel is in}\DIFdelend \DIFaddbegin \DIFadd{hotel's price range}\DIFaddend , some other factors stay mostly constant for each culture's customers. For example, appreciation for staff from English-speaking tourists is ranked close to the top satisfaction factor in all the price ranges. Satisfaction for cleanliness by both cultures constantly stays part of the top 10 keywords, except for the most expensive one, where other keywords take \DIFdelbegin \DIFdel{its }\DIFdelend \DIFaddbegin \DIFadd{that }\DIFaddend place in the ranking. However, it is still high on the list. Chinese tourists have a high ranking for the word ``\begin{CJK}{UTF8}{gbsn}早餐\end{CJK} (breakfast)'' across all price ranges as well. \DIFdelbegin \DIFdel{Transport and location, as }\DIFdelend \DIFaddbegin \DIFadd{As }\DIFaddend discussed in section \ref{disc:location}, \DIFaddbegin \DIFadd{transport and location }\DIFaddend are also important for hotels of all classes and prices. While the ranking of attributes might differ between price ranges, hard and soft attribute proportions also appear to be constant within at most a 13\% margin of error per attribute, often being lower. This suggests that culturally the customers have a \DIFdelbegin \DIFdel{certain }\DIFdelend \DIFaddbegin \DIFadd{particular }\DIFaddend bias to consider some attributes more than others.

  \subsection{Implications for hotel managers}\label{disc:implications}

    Our study presents two important conclusions: one about hospitality and cultural differences, and another about managerial decisions towards two different populations. As a whole, Chinese tourists are not showing the most satisfaction towards hospitality and service factors. Instead, they focus on the hard attributes of a hotel. Either they do not get as much satisfaction from hospitality as Western tourists \DIFdelbegin \DIFdel{, }\DIFdelend or feel that basic language and communication needs are not being met, so they receive a lesser impression. On the other hand, Western tourists are elated with Japanese hospitality, preferring soft attributes \DIFdelbegin \DIFdel{that management and staff can directly influence }\DIFdelend to hard-set ones. The other conclusion is that managerial decisions will mostly benefit Western tourists, except that Chinese language improvements and breakfast inclusion can satisfy more Chinese customers. Japan is recently seeing an increase in Chinese students as well as Western students of universities. Hiring students as part-time workers could increase the language services of a hotel.
...
\section{Limitations and Future Work}\label{limitations}
  ...
  This paper is not without its limitations. We analyzed satisfaction and dissatisfaction keywords based on whether they appeared on satisfied reviews or dissatisfied ones. Following that, we attempted to understand the context \DIFdelbegin \DIFdel{that }\DIFdelend \DIFaddbegin \DIFadd{in which }\DIFaddend these words were \DIFdelbegin \DIFdel{being used in }\DIFdelend \DIFaddbegin \DIFadd{used }\DIFaddend by using a dependency parser and observing the related nouns. However, the study is limited in that it only analyzes the words directly related to each keyword and does not follow the upstream or downstream path down further connections. This means that if the words are used in combination with other keywords, we did not trace the effects of multiple contradicting statements. For example, in the sentence ``The room is good, but the food is lacking'', we would extract ``good food'' and ``lacking food'', but do not consider the fact that both occurred in the same sentence.

  This study analyzed the differences in customers' expectations at different levels of hospitality and service factors by dividing our data into price ranges. However, in the same price range, for example, the highest one, we can find both a western-style five-star resort and a high-end Japanese-style \textit{ryokan}. Services offered in these hotels are very high quality, although very different. However, most of our database is focused on the middle range priced hotels, which is comparably less varied in service\DIFdelbegin \DIFdel{, although still there is }\DIFdelend \DIFaddbegin \DIFadd{. However, there is still }\DIFaddend a divide between western and Japanese style hotels.

  An \DIFdelbegin \DIFdel{important }\DIFdelend \DIFaddbegin \DIFadd{essential }\DIFaddend aspect of this study is that we focus on the satisfaction and dissatisfaction towards expectations of individual aspects of the hotels. This gives us insight \DIFdelbegin \DIFdel{on which factors are possible to }\DIFdelend \DIFaddbegin \DIFadd{into which factors can }\DIFaddend focus on by hotel managers in applying this knowledge. However, our study was limited in that the overall satisfaction of each \DIFdelbegin \DIFdel{individual }\DIFdelend customer was not measured. This could be done by rating the volume of text used to describe satisfaction factors against the \DIFdelbegin \DIFdel{volume of text }\DIFdelend \DIFaddbegin \DIFadd{text volume }\DIFaddend used for dissatisfaction. However, this imposes a few difficulties that are out of the scope of this study. 
