...
%DIF ADD tmp-emotion-after.tex    Tue Oct  1 16:19:01 2019
...
\subsection{\DIFdelbegin \DIFdel{English speaking }\DIFdelend \DIFaddbegin \DIFadd{English-speaking }\DIFaddend tourists' satisfaction and dissatisfaction keywords}
...
\subsection{Comparison of Chinese and \DIFdelbegin \DIFdel{English speaking }\DIFdelend \DIFaddbegin \DIFadd{English-speaking }\DIFaddend tourists' preferences}
...
\subsection{\DIFaddbegin \DIFadd{Chinese tourists - A big, clean space, and Chinese friendly}\DIFaddend }\DIFaddbegin \label{disc:zh}
\DIFaddend 
...
\DIFaddbegin \subsection{\DIFadd{Western tourists - A friendly face, and absolutely clean}}\label{disc:en}
\DIFaddend 
...
\DIFaddbegin \subsection{\DIFadd{Price, the common enemy}}\label{disc:price}
\DIFaddend 
...
\DIFaddbegin \subsection{\DIFadd{Location, location, location}}\label{disc:location}
\DIFaddend 
...
\DIFaddbegin \subsection{\DIFadd{Tobacco, what's that smell?}}\label{disc:tobacco}
\DIFaddend 
...
%DIFAUXCMD
\DIFdelend \DIFaddbegin \DIFadd{However, in comparison, Chinese customers seem to not be bothered by this at all. We consulted studies involving the use of tobacco in different countries. Previous research states that 49 - 60\% of Chinese men (and 2.0 - 2.8\% of women) currently smoke or have smoked before, taken from a sample of \num[group-separator={,}]{170000} Chinese adults in 2013-2014, which is high compared to many English-speaking countries \mbox{%DIFAUXCMD
...
\subsection{\DIFadd{Managerial vs. Environmental satisfaction}}\label{disc:hyp3}
...
\section{\DIFadd{Limitations}}\label{limitations}
...
\section{\DIFadd{Conclusion and Future Work}}\label{conclusion}
...
\section{\DIFadd{Managerial and Environmental keywords}}
